...
- Gráficos de Proporção: Distribuição percentual do modelo de trabalho (Remoto, Híbrido, Presencial).
- KPIs Executivos: Indicadores em tempo real baseados nos filtros aplicados na barra lateral.

## 🛠 Tecnologias
- Python: Linguagem base do projeto.
- Streamlit: Framework para criação da interface web interativa.
- Pandas: Manipulação e análise estruturada do dataset CSV.
- Plotly Express: Geração de gráficos dinâmicos e mapas interativos.

## 📈 KPIs e Dados Analisados
- Média Salarial (USD): Por cargo e nível de experiência.
- Distribuição de Cargos: Principais funções como Data Scientist, Data Engineer e Data Analyst.
